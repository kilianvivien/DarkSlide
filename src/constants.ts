...
const TONAL_CHARACTERS: Record<string, TonalCharacter> = {
  ...
  'ektacolor-pro-160': { shadowLift: 0.13, highlightRolloff: 0.68, midtoneAnchor: 0 },
  'ektacolor-pro-400': { shadowLift: 0.16, highlightRolloff: 0.72, midtoneAnchor: 0.01 },
  'ektacolor-pro-800': { shadowLift: 0.19, highlightRolloff: 0.74, midtoneAnchor: 0.02 },
  ...
  'vision3-50d': { shadowLift: 0.14, highlightRolloff: 0.76, midtoneAnchor: -0.01 },
  'vision3-200t': { shadowLift: 0.16, highlightRolloff: 0.8, midtoneAnchor: -0.01 },
  'verita-200d': { shadowLift: 0.1, highlightRolloff: 0.58, midtoneAnchor: 0.01 },
  'harman-phoenix-200': { shadowLift: 0.02, highlightRolloff: 0.24, midtoneAnchor: 0.03 },
  'harman-phoenix-ii-200': { shadowLift: 0.03, highlightRolloff: 0.32, midtoneAnchor: 0.02 },
  'harman-red-125': { shadowLift: 0.02, highlightRolloff: 0.28, midtoneAnchor: 0.03 },
  'harman-switch-azure': { shadowLift: 0.04, highlightRolloff: 0.34, midtoneAnchor: 0.01 },
  ...
  'lomo-metropolis': { shadowLift: 0.02, highlightRolloff: 0.30, midtoneAnchor: 0 },
  'lomo-purple': { shadowLift: 0.04, highlightRolloff: 0.36, midtoneAnchor: 0.01 },
  'lomo-turquoise': { shadowLift: 0.04, highlightRolloff: 0.36, midtoneAnchor: 0.01 },
  'lomo-classicolor-200': { shadowLift: 0.07, highlightRolloff: 0.45, midtoneAnchor: 0.01 },
  'lomo-redscale-xr': { shadowLift: 0.02, highlightRolloff: 0.30, midtoneAnchor: 0.02 },
  ...
  'cinestill-bwxx': { shadowLift: 0.06, highlightRolloff: 0.42, midtoneAnchor: 0 },
  'plus-x': { shadowLift: 0.06, highlightRolloff: 0.50, midtoneAnchor: 0 },
  'ektapan-100': { shadowLift: 0.06, highlightRolloff: 0.56, midtoneAnchor: 0 },
  'ektapan-400': { shadowLift: 0.05, highlightRolloff: 0.46, midtoneAnchor: 0 },
  'ektapan-p3200': { shadowLift: 0.02, highlightRolloff: 0.25, midtoneAnchor: -0.02 },
  'ortho-plus': { shadowLift: 0.03, highlightRolloff: 0.36, midtoneAnchor: -0.01 },
  'kentmere-100': { shadowLift: 0.06, highlightRolloff: 0.46, midtoneAnchor: 0 },
  'lomo-potsdam-100': { shadowLift: 0.05, highlightRolloff: 0.42, midtoneAnchor: 0 },
  'lomo-berlin-400': { shadowLift: 0.07, highlightRolloff: 0.44, midtoneAnchor: 0.01 },
...
const COLOR_MATRICES: Record<string, ColorMatrix> = {
  ...
  'ektacolor-pro-160': [1.11, -0.08, -0.03, -0.03, 1.06, -0.03, -0.02, -0.05, 1.07],
  'ektacolor-pro-400': [1.14, -0.09, -0.05, -0.04, 1.08, -0.04, -0.02, -0.06, 1.08],
  'ektacolor-pro-800': [1.15, -0.10, -0.05, -0.04, 1.08, -0.04, -0.02, -0.06, 1.08],
  ...
  'vision3-50d': [1.10, -0.07, -0.03, -0.03, 1.05, -0.02, -0.01, -0.04, 1.05],
  'vision3-200t': [1.07, -0.05, -0.02, -0.02, 1.04, -0.02, -0.01, -0.03, 1.04],
  'verita-200d': [1.18, -0.10, -0.08, -0.05, 1.09, -0.04, -0.03, -0.07, 1.10],
  'harman-phoenix-200': [1.30, -0.17, -0.13, -0.09, 1.16, -0.07, -0.04, -0.10, 1.14],
  'harman-phoenix-ii-200': [1.24, -0.14, -0.10, -0.07, 1.13, -0.06, -0.03, -0.09, 1.12],
  'harman-red-125': [1.44, -0.20, -0.24, -0.03, 1.08, -0.05, 0.04, -0.18, 1.14],
  'harman-switch-azure': [0.96, -0.04, 0.08, -0.05, 1.06, -0.01, -0.10, -0.08, 1.18],
  ...
  'lomo-metropolis': [1.16, -0.08, -0.08, -0.06, 1.08, -0.02, -0.04, -0.06, 1.10],
  'lomo-purple': [0.98, -0.06, 0.08, -0.08, 1.10, -0.02, 0.10, -0.16, 1.06],
  'lomo-turquoise': [0.92, -0.05, 0.13, -0.04, 1.08, -0.04, -0.13, -0.08, 1.21],
  'lomo-classicolor-200': [1.13, -0.08, -0.05, -0.04, 1.07, -0.03, -0.02, -0.06, 1.08],
  'lomo-redscale-xr': [1.42, -0.20, -0.22, -0.03, 1.08, -0.05, 0.04, -0.17, 1.13],
};
...
export const FILM_STOCK_DENSITY_PRESETS: Record<string, Omit<DensityBalance, 'source'>> = {
  ...
  'ektacolor-pro-160': { scaleR: 1, scaleG: 1, scaleB: 0.63 },
  ...
  'vision3-50d': { scaleR: 1, scaleG: 1, scaleB: 0.59 },
  'vision3-200t': { scaleR: 1, scaleG: 1, scaleB: 0.65 },
  'verita-200d': { scaleR: 1, scaleG: 1, scaleB: 0.6 },
  'harman-phoenix-200': { scaleR: 1, scaleG: 1, scaleB: 0.74 },
  'harman-phoenix-ii-200': { scaleR: 1, scaleG: 1, scaleB: 0.72 },
  'harman-red-125': { scaleR: 1, scaleG: 0.82, scaleB: 0.42 },
  'harman-switch-azure': { scaleR: 1, scaleG: 1, scaleB: 0.7 },
  ...
  'lomo-metropolis': { scaleR: 1, scaleG: 1, scaleB: 0.59 },
  'lomo-purple': { scaleR: 1, scaleG: 1, scaleB: 0.58 },
  'lomo-turquoise': { scaleR: 1, scaleG: 1, scaleB: 0.62 },
  'lomo-classicolor-200': { scaleR: 1, scaleG: 1, scaleB: 0.6 },
  'lomo-redscale-xr': { scaleR: 1, scaleG: 0.82, scaleB: 0.42 },
...
export const FILM_PROFILES: FilmProfile[] = [
  ...
  createBuiltinProfile({
    id: 'ektacolor-pro-160',
    name: 'Kodak Ektacolor Pro 160',
    type: 'color',
    filmType: 'negative',
    category: 'Kodak',
    description: 'Current Kodak professional 160-speed color negative with soft color and natural skin tones.',
    defaultSettings: createDefaultSettings({ exposure: 2, contrast: 8, saturation: 103, temperature: 2, tint: -1, redBalance: 1.09, blueBalance: 0.93, highlightProtection: 32, blackPoint: 6 }),
    maskTuning: { highlightProtectionBias: 0.07, blackPointBias: -0.02 },
    colorMatrix: COLOR_MATRICES['ektacolor-pro-160'],
    tonalCharacter: TONAL_CHARACTERS['ektacolor-pro-160'],
  }),
  createBuiltinProfile({
    id: 'ektacolor-pro-400',
    name: 'Kodak Ektacolor Pro 400',
    type: 'color',
    filmType: 'negative',
    category: 'Kodak',
    description: 'Current Kodak professional 400-speed color negative with broad latitude and balanced saturation.',
    defaultSettings: createDefaultSettings({ exposure: 4, contrast: 10, saturation: 106, temperature: 3, tint: -1, redBalance: 1.12, blueBalance: 0.9, highlightProtection: 36, blackPoint: 7 }),
    maskTuning: { highlightProtectionBias: 0.09, blackPointBias: -0.02 },
    colorMatrix: COLOR_MATRICES['ektacolor-pro-400'],
    tonalCharacter: TONAL_CHARACTERS['ektacolor-pro-400'],
  }),
  createBuiltinProfile({
    id: 'ektacolor-pro-800',
    name: 'Kodak Ektacolor Pro 800',
    type: 'color',
    filmType: 'negative',
    category: 'Kodak',
    description: 'Current Kodak professional 800-speed color negative for low light with smooth highlight handling.',
    defaultSettings: createDefaultSettings({ exposure: 7, contrast: 9, saturation: 105, temperature: 3, tint: -1, redBalance: 1.13, blueBalance: 0.9, highlightProtection: 38, blackPoint: 7 }),
    maskTuning: { highlightProtectionBias: 0.09, blackPointBias: -0.02 },
    colorMatrix: COLOR_MATRICES['ektacolor-pro-800'],
    tonalCharacter: TONAL_CHARACTERS['ektacolor-pro-800'],
  }),
  createBuiltinProfile({
    id: 'pro-image-100',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Kodak',
    description: 'Fine-grain daylight cinema stock with clean color and a generous highlight shoulder.',
    defaultSettings: createDefaultSettings({ exposure: 3, contrast: 7, saturation: 98, temperature: 1, tint: -1, redBalance: 1.07, blueBalance: 0.96, highlightProtection: 40, blackPoint: 6 }),
    maskTuning: { highlightProtectionBias: 0.11, blackPointBias: -0.03 },
    colorMatrix: COLOR_MATRICES['vision3-50d'],
    tonalCharacter: TONAL_CHARACTERS['vision3-50d'],
  }),
  createBuiltinProfile({
    id: 'vision3-200t',
    ...
    filmType: 'negative',
    category: 'Kodak',
    description: 'Tungsten-balanced cinema stock with smooth grain, cool shadows, and strong highlight latitude.',
    defaultSettings: createDefaultSettings({ exposure: 6, contrast: 8, saturation: 99, temperature: -5, tint: 1, redBalance: 1.12, blueBalance: 1.01, highlightProtection: 42, blackPoint: 6 }),
    maskTuning: { highlightProtectionBias: 0.12, blackPointBias: -0.03 },
    colorMatrix: COLOR_MATRICES['vision3-200t'],
    tonalCharacter: TONAL_CHARACTERS['vision3-200t'],
  }),
  createBuiltinProfile({
    id: 'vision3-250d',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Kodak',
    description: 'Daylight cinema stock with warm skin tones, bold color, and deeper blacks.',
    defaultSettings: createDefaultSettings({ exposure: 4, contrast: 15, saturation: 116, temperature: 4, tint: -1, redBalance: 1.13, blueBalance: 0.9, highlightProtection: 28, blackPoint: 9 }),
    maskTuning: { highlightProtectionBias: 0.06, blackPointBias: 0 },
    colorMatrix: COLOR_MATRICES['verita-200d'],
    tonalCharacter: TONAL_CHARACTERS['verita-200d'],
  }),
  createBuiltinProfile({
    id: 'fuji-c200',
    name: 'Fujifilm C200',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'CineStill',
    description: 'CineStill panchromatic B&W cinema stock with classic Double-X contrast and flexible speed.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 29, highlightProtection: 22, blackPoint: 13 }),
    tonalCharacter: TONAL_CHARACTERS['cinestill-bwxx'],
  }),
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Harman',
    description: 'Original Harman color stock with high contrast, strong grain, and an experimental no-orange-mask response.',
    defaultSettings: createDefaultSettings({ exposure: 2, contrast: 27, saturation: 132, temperature: 2, tint: 2, redBalance: 1.1, blueBalance: 0.95, highlightProtection: 18, blackPoint: 12 }),
    maskTuning: { highlightProtectionBias: 0.02, blackPointBias: 0.02 },
    colorMatrix: COLOR_MATRICES['harman-phoenix-200'],
    tonalCharacter: TONAL_CHARACTERS['harman-phoenix-200'],
  }),
  createBuiltinProfile({
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Harman',
    description: 'Redscale Phoenix-derived C-41 film with orange-red tones and dense, graphic contrast.',
    defaultSettings: createDefaultSettings({ exposure: 3, contrast: 24, saturation: 122, temperature: 16, tint: 3, redBalance: 1.32, greenBalance: 0.9, blueBalance: 0.62, highlightProtection: 18, blackPoint: 12 }),
    maskTuning: { highlightProtectionBias: 0.02, blackPointBias: 0.02 },
    colorMatrix: COLOR_MATRICES['harman-red-125'],
    tonalCharacter: TONAL_CHARACTERS['harman-red-125'],
  }),
  createBuiltinProfile({
    id: 'harman-switch-azure',
    name: 'Harman Switch Azure',
    type: 'color',
    filmType: 'negative',
    category: 'Harman',
    description: 'Experimental Harman color stock tuned for cool cyan-blue shifts and crisp contrast.',
    defaultSettings: createDefaultSettings({ exposure: 3, contrast: 21, saturation: 118, temperature: -8, tint: 4, redBalance: 0.98, greenBalance: 1.02, blueBalance: 1.12, highlightProtection: 22, blackPoint: 10 }),
    maskTuning: { highlightProtectionBias: 0.04, blackPointBias: 0.01 },
    colorMatrix: COLOR_MATRICES['harman-switch-azure'],
    tonalCharacter: TONAL_CHARACTERS['harman-switch-azure'],
  }),
  createBuiltinProfile({
    id: 'lomo-400',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Lomography',
    description: 'Muted LomoChrome stock with punchy contrast, subdued color, and strong accent tones.',
    defaultSettings: createDefaultSettings({ exposure: 2, contrast: 24, saturation: 86, temperature: -2, tint: 1, redBalance: 1.04, blueBalance: 0.98, highlightProtection: 18, blackPoint: 12 }),
    colorMatrix: COLOR_MATRICES['lomo-metropolis'],
    tonalCharacter: TONAL_CHARACTERS['lomo-metropolis'],
  }),
  createBuiltinProfile({
    id: 'lomo-purple',
    ...
    filmType: 'negative',
    category: 'Lomography',
    description: 'Color-shifting LomoChrome profile with violet foliage shifts and saturated magenta accents.',
    defaultSettings: createDefaultSettings({ exposure: 3, contrast: 17, saturation: 116, temperature: 0, tint: 8, redBalance: 1.08, greenBalance: 0.96, blueBalance: 1.04, highlightProtection: 22, blackPoint: 9 }),
    colorMatrix: COLOR_MATRICES['lomo-purple'],
    tonalCharacter: TONAL_CHARACTERS['lomo-purple'],
  }),
  createBuiltinProfile({
    id: 'lomo-turquoise',
    ...
    filmType: 'negative',
    category: 'Lomography',
    description: 'Color-shifting LomoChrome profile with teal skies, warm oranges, and surreal cool shadows.',
    defaultSettings: createDefaultSettings({ exposure: 3, contrast: 17, saturation: 114, temperature: -6, tint: 3, redBalance: 0.98, greenBalance: 1.02, blueBalance: 1.12, highlightProtection: 22, blackPoint: 9 }),
    colorMatrix: COLOR_MATRICES['lomo-turquoise'],
    tonalCharacter: TONAL_CHARACTERS['lomo-turquoise'],
  }),
  createBuiltinProfile({
    id: 'lomo-classicolor-200',
    name: 'LomoChrome Classicolor 200',
    type: 'color',
    filmType: 'negative',
    category: 'Lomography',
    description: 'Handcrafted LomoChrome color negative with true-to-life color and soft analogue warmth.',
    defaultSettings: createDefaultSettings({ exposure: 3, contrast: 14, saturation: 112, temperature: 3, tint: -1, redBalance: 1.1, blueBalance: 0.92, highlightProtection: 24, blackPoint: 8 }),
    colorMatrix: COLOR_MATRICES['lomo-classicolor-200'],
    tonalCharacter: TONAL_CHARACTERS['lomo-classicolor-200'],
  }),
  createBuiltinProfile({
    id: 'lomo-redscale-xr',
    name: 'Lomography Redscale XR',
    type: 'color',
    filmType: 'negative',
    category: 'Lomography',
    description: 'Extended-range redscale stock with glowing reds, oranges, yellows, and occasional cool edges.',
    defaultSettings: createDefaultSettings({ exposure: 4, contrast: 24, saturation: 124, temperature: 18, tint: 2, redBalance: 1.34, greenBalance: 0.9, blueBalance: 0.62, highlightProtection: 18, blackPoint: 12 }),
    colorMatrix: COLOR_MATRICES['lomo-redscale-xr'],
    tonalCharacter: TONAL_CHARACTERS['lomo-redscale-xr'],
  }),
  createBuiltinProfile({
    id: 'velvia-50',
    name: 'Fuji Velvia 50',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Kodak',
    description: 'Current Kodak tabular-grain B&W stock with very fine grain, high sharpness, and clean tonality.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 18, highlightProtection: 30, blackPoint: 10 }),
    tonalCharacter: TONAL_CHARACTERS['ektapan-100'],
  }),
  createBuiltinProfile({
    id: 'ektapan-400',
    name: 'Kodak Ektapan 400',
    type: 'bw',
    filmType: 'negative',
    category: 'Kodak',
    description: 'Current Kodak 400-speed tabular B&W stock with crisp detail and restrained grain.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 24, highlightProtection: 26, blackPoint: 12 }),
    tonalCharacter: TONAL_CHARACTERS['ektapan-400'],
  }),
  createBuiltinProfile({
    id: 'ektapan-p3200',
    name: 'Kodak Ektapan P3200',
    type: 'bw',
    filmType: 'negative',
    category: 'Kodak',
    description: 'Push-friendly high-speed Kodak B&W profile for low light with strong mids and protected highlights.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 39, highlightProtection: 20, blackPoint: 17, whitePoint: 240 }),
    tonalCharacter: TONAL_CHARACTERS['ektapan-p3200'],
  }),
  createBuiltinProfile({
    id: 'fp4',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Ilford',
    description: 'Fine-grain orthochromatic B&W with darker reds, crisp landscapes, and strong edge contrast.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 27, highlightProtection: 20, blackPoint: 13 }),
    tonalCharacter: TONAL_CHARACTERS['ortho-plus'],
  }),
  // --- Kentmere ---
  createBuiltinProfile({
    id: 'kentmere-100',
    ...
    filmType: 'negative',
    category: 'Kentmere',
    description: 'Accessible fine-grain B&W with clean detail, forgiving latitude, and balanced contrast.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 21, highlightProtection: 26, blackPoint: 10 }),
    tonalCharacter: TONAL_CHARACTERS['kentmere-100'],
  }),
  createBuiltinProfile({
    id: 'kentmere-200',
  ...
  createBuiltinProfile({
    id: 'lomo-potsdam-100',
    name: 'Lomography Potsdam Kino 100',
    type: 'bw',
    filmType: 'negative',
    category: 'Lomography',
    description: 'Cinematic 100-speed B&W with firm contrast, fine texture, and dramatic greyscale separation.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 25, highlightProtection: 22, blackPoint: 12 }),
    tonalCharacter: TONAL_CHARACTERS['lomo-potsdam-100'],
  }),
  createBuiltinProfile({
    id: 'lomo-berlin-400',
    ...
    filmType: 'negative',
    category: 'Lomography',
    description: 'Cinematic 400-speed B&W with rich mids, visible grain, and moody contrast.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 28, highlightProtection: 22, blackPoint: 13 }),
    tonalCharacter: TONAL_CHARACTERS['lomo-berlin-400'],
  }),
  // --- Foma ---
  createBuiltinProfile({
    id: 'fomapan-100',
