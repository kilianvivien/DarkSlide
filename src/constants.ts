...
const TONAL_CHARACTERS: Record<string, TonalCharacter> = {
  ...
  'kodacolor-100': { shadowLift: 0.07, highlightRolloff: 0.44, midtoneAnchor: 0.01 },
  'kodacolor-200': { shadowLift: 0.08, highlightRolloff: 0.46, midtoneAnchor: 0.01 },
  ...
  'fujifilm-400': { shadowLift: 0.09, highlightRolloff: 0.52, midtoneAnchor: -0.005 },
  ...
  'harman-phoenix-ii-200': { shadowLift: 0.03, highlightRolloff: 0.32, midtoneAnchor: 0.02 },
  ...
  'lomo-color-92': { shadowLift: 0.05, highlightRolloff: 0.38, midtoneAnchor: 0.01 },
  'lomo-color-92-sunkissed': { shadowLift: 0.06, highlightRolloff: 0.42, midtoneAnchor: 0.02 },
  'generic-bw': { shadowLift: 0.04, highlightRolloff: 0.5, midtoneAnchor: 0 },
  'acros-100-ii': { shadowLift: 0.05, highlightRolloff: 0.58, midtoneAnchor: 0 },
  ...
  'kentmere-200': { shadowLift: 0.06, highlightRolloff: 0.44, midtoneAnchor: 0 },
  'kentmere-400': { shadowLift: 0.08, highlightRolloff: 0.50, midtoneAnchor: 0.01 },
};
...
const COLOR_MATRICES: Record<string, ColorMatrix> = {
  ...
  'kodacolor-100': [1.15, -0.09, -0.06, -0.04, 1.08, -0.04, -0.02, -0.06, 1.09],
  'kodacolor-200': [1.16, -0.10, -0.06, -0.04, 1.08, -0.04, -0.02, -0.06, 1.09],
  'fuji-400h': [1.1, -0.06, -0.04, -0.02, 1.05, -0.03, -0.01, -0.04, 1.05],
  'fujifilm-200': [1.10, -0.06, -0.04, -0.02, 1.05, -0.03, -0.01, -0.04, 1.06],
  'fujifilm-400': [1.13, -0.08, -0.05, -0.03, 1.07, -0.04, -0.02, -0.05, 1.07],
  'superia-400': [1.12, -0.07, -0.05, -0.03, 1.06, -0.03, -0.02, -0.05, 1.07],
  'cinestill-800t': [1.08, -0.05, -0.03, -0.02, 1.04, -0.02, -0.01, -0.03, 1.04],
  'harman-phoenix-ii-200': [1.24, -0.14, -0.10, -0.07, 1.13, -0.06, -0.03, -0.09, 1.12],
  'lomo-400': [1.22, -0.13, -0.09, -0.06, 1.11, -0.05, -0.04, -0.09, 1.13],
  'lomo-800': [1.20, -0.12, -0.08, -0.05, 1.10, -0.05, -0.03, -0.08, 1.11],
  'lomo-color-92': [1.18, -0.10, -0.08, -0.05, 1.08, -0.03, -0.03, -0.07, 1.10],
  'lomo-color-92-sunkissed': [1.20, -0.11, -0.09, -0.06, 1.09, -0.03, -0.04, -0.08, 1.12],
};
...
export const FILM_STOCK_DENSITY_PRESETS: Record<string, Omit<DensityBalance, 'source'>> = {
  ...
  'kodacolor-100': { scaleR: 1, scaleG: 1, scaleB: 0.6 },
  'kodacolor-200': { scaleR: 1, scaleG: 1, scaleB: 0.6 },
  'fuji-400h': { scaleR: 1, scaleG: 1, scaleB: 0.53 },
  'superia-400': { scaleR: 1, scaleG: 1, scaleB: 0.55 },
  'fujifilm-400': { scaleR: 1, scaleG: 1, scaleB: 0.57 },
  ...
  'harman-phoenix-ii-200': { scaleR: 1, scaleG: 1, scaleB: 0.72 },
  'lomo-400': { scaleR: 1, scaleG: 1, scaleB: 0.58 },
  'lomo-800': { scaleR: 1, scaleG: 1, scaleB: 0.59 },
  'lomo-color-92': { scaleR: 1, scaleG: 1, scaleB: 0.6 },
  'lomo-color-92-sunkissed': { scaleR: 1, scaleG: 1, scaleB: 0.61 },
...
export const FILM_PROFILES: FilmProfile[] = [
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Kodak',
    description: 'Current Kodak consumer 100-speed stock with clean detail and saturated daylight color.',
    defaultSettings: createDefaultSettings({ exposure: 2, contrast: 14, saturation: 116, temperature: 4, tint: -1, redBalance: 1.11, blueBalance: 0.91, highlightProtection: 26, blackPoint: 7 }),
    colorMatrix: COLOR_MATRICES['kodacolor-100'],
    tonalCharacter: TONAL_CHARACTERS['kodacolor-100'],
  }),
  createBuiltinProfile({
    id: 'kodacolor-200',
    ...
    filmType: 'negative',
    category: 'Kodak',
    description: 'Accessible Kodak daylight stock with warm color, fine grain, and gentle lo-fi contrast.',
    defaultSettings: createDefaultSettings({ exposure: 4, contrast: 15, saturation: 118, temperature: 6, tint: -1, redBalance: 1.13, blueBalance: 0.9, highlightProtection: 24, blackPoint: 8 }),
    colorMatrix: COLOR_MATRICES['kodacolor-200'],
    tonalCharacter: TONAL_CHARACTERS['kodacolor-200'],
  }),
  createBuiltinProfile({
    id: 'gold-100',
    name: 'Kodak Gold 100',
  ...
  createBuiltinProfile({
    id: 'harman-phoenix-ii-200',
    name: 'Harman Phoenix II 200',
    type: 'color',
    filmType: 'negative',
    category: 'Harman',
    description: 'Second-generation Harman color stock with punchy contrast and improved color accuracy.',
    defaultSettings: createDefaultSettings({ exposure: 2, contrast: 22, saturation: 124, temperature: 1, tint: 1, redBalance: 1.08, blueBalance: 0.96, highlightProtection: 22, blackPoint: 10 }),
    maskTuning: { highlightProtectionBias: 0.04, blackPointBias: 0.01 },
    colorMatrix: COLOR_MATRICES['harman-phoenix-ii-200'],
    tonalCharacter: TONAL_CHARACTERS['harman-phoenix-ii-200'],
  }),
  createBuiltinProfile({
    id: 'lomo-400',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Lomography',
    description: "Retro 400-speed LomoChrome stock with delicate pastels, visible grain, and vivid accents.",
    defaultSettings: createDefaultSettings({ exposure: 3, contrast: 18, saturation: 118, temperature: -1, tint: 2, redBalance: 1.08, blueBalance: 0.98, highlightProtection: 22, blackPoint: 9 }),
    colorMatrix: COLOR_MATRICES['lomo-color-92'],
    tonalCharacter: TONAL_CHARACTERS['lomo-color-92'],
  }),
  createBuiltinProfile({
    id: 'lomo-color-92-sunkissed',
    name: "LomoChrome Color '92 Sun-kissed",
    type: 'color',
    filmType: 'negative',
    category: 'Lomography',
    description: "Warm Color '92 variant with golden-orange tones, glowing skin, and nostalgic contrast.",
    defaultSettings: createDefaultSettings({ exposure: 4, contrast: 19, saturation: 122, temperature: 8, tint: 1, redBalance: 1.14, blueBalance: 0.88, highlightProtection: 20, blackPoint: 10 }),
    colorMatrix: COLOR_MATRICES['lomo-color-92-sunkissed'],
    tonalCharacter: TONAL_CHARACTERS['lomo-color-92-sunkissed'],
  }),
  createBuiltinProfile({
    id: 'velvia-50',
    name: 'Fuji Velvia 50',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Fuji',
    description: 'Current Fuji 400-speed consumer color film with natural saturation and broad latitude.',
    defaultSettings: createDefaultSettings({ exposure: 4, contrast: 14, saturation: 114, temperature: -1, tint: 1, redBalance: 1.08, greenBalance: 1.03, blueBalance: 0.98, highlightProtection: 24, blackPoint: 8 }),
    colorMatrix: COLOR_MATRICES['fujifilm-400'],
    tonalCharacter: TONAL_CHARACTERS['fujifilm-400'],
  }),
  createBuiltinProfile({
    id: 'astia-100f',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Fuji',
    description: 'Ultra-fine-grain orthopanchromatic B&W with smooth gradation and crisp detail.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 18, highlightProtection: 30, blackPoint: 9, whitePoint: 246 }),
    tonalCharacter: TONAL_CHARACTERS['acros-100-ii'],
  }),
  // --- Ilford additions ---
  createBuiltinProfile({
    id: 'xp2-super',
  ...
  createBuiltinProfile({
    ...
    filmType: 'negative',
    category: 'Kentmere',
    description: 'Accessible mid-speed B&W with forgiving latitude, textured grain, and lively contrast.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 23, highlightProtection: 24, blackPoint: 11 }),
    tonalCharacter: TONAL_CHARACTERS['kentmere-200'],
  }),
  createBuiltinProfile({
    id: 'kentmere-400',
    ...
    filmType: 'negative',
    category: 'Kentmere',
    description: 'Flexible high-speed B&W with broad tonal range and beginner-friendly latitude.',
    defaultSettings: createDefaultSettings({ saturation: 0, contrast: 22, highlightProtection: 26, blackPoint: 11 }),
    tonalCharacter: TONAL_CHARACTERS['kentmere-400'],
  }),
  // --- Foma ---
  createBuiltinProfile({
    id: 'fomapan-100',
